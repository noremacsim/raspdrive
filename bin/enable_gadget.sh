...
echo "USB-$(grep Serial /proc/cpuinfo | awk '{print $3}')" > "$gadget_root/strings/$lang/serialnumber"
echo USB > "$gadget_root/strings/$lang/manufacturer"
echo "USB Composite Gadget" > "$gadget_root/strings/$lang/product"
echo "USB Config" > "$gadget_root/configs/$cfg.1/strings/$lang/configuration"
...
echo "USB $(du -h /mnt/connectedUSB/usbdata.bin | awk '{print $1}')" > "$gadget_root/functions/mass_storage.0/lun.0/inquiry_string"
